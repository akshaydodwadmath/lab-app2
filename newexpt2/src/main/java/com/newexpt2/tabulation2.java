...
import com.newexpt2.Compress;
import com.newexpt2.Filehtml;
import com.newexpt2.HeaderHTM;
import com.newexpt2.Upload;
import com.newexpt2.tabulation2;
import com.newexpt2.R;
...
import android.widget.TableLayout.LayoutParams;
        ...
        public class tabulation2 extends Activity {
        	...
        	public void onCreate(Bundle savedInstanceState) {
                ...
                setContentView(R.layout.tabulation2);
...
//        				tr1.setVisibility(View.INVISIBLE);
        		...
        		clear.setOnClickListener(new OnClickListener() {
        			...
        			public void onClick(View arg0) {
        				...
        				myintent.setClass(getApplicationContext(), tabulation2.class);
        		...
        		conclusion.setOnClickListener(new OnClickListener() {
        			...
        			public void onClick(View arg0) {
        				...
        				final Dialog dialog = new Dialog(tabulation2.this);
                        dialog.setContentView(R.layout.conclusion2);
...
//            				String filecalculation[]=new String[1];
            				...
            				try
            				{
            					...
            					File folder1 = new File("/sdcard/newexpt2/tab/");
            					if(!folder1.exists())
            						folder1.mkdir();
            					else
            					{
            				...
            				String file="/sdcard/newexpt2/tab/"+rno+"_expt2.html";
...
//            				htm.write_calc(filecalculation);
              			...
              			String []ss=new String[1];
            				...
            				//String []ss=new String[1];
            				Compress c =new Compress(ss, "/sdcard/newexpt2/tab/"+rno+"_expt2.zip"); 
            				c.zip();
            				//<<<<<<<<<<<<<UPLOADING>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>

            				AlertDialog.Builder builder = new AlertDialog.Builder(tabulation2.this);

...
import android.widget.TableLayout.LayoutParams;
        ...
        public class tabulation3 extends Activity {
        	...
        	public void onCreate(Bundle savedInstanceState) {
                ...
                setContentView(R.layout.tabulation4);
...
//        				tr1.setVisibility(View.INVISIBLE);
        		...
        		clear.setOnClickListener(new OnClickListener() {
        			...
        			public void onClick(View arg0) {
        				...
        				myintent.setClass(getApplicationContext(), tabulation4.class);
        		...
        		conclusion.setOnClickListener(new OnClickListener() {
        			...
        			public void onClick(View arg0) {
        				...
        				final Dialog dialog = new Dialog(tabulation3.this);
...
//            				String filecalculation[]=new String[1];
            				...
            				try
            				{
            					...
            					File folder1 = new File("/sdcard/newexpt3/inv/");
            					if(!folder1.exists())
            						folder1.mkdir();
            					else
            					{
            				...
            				String file="/sdcard/newexpt3/inv/"+rno+"_expti3.html";
            				
            				Filehtml htm=new Filehtml(file);
            			
            				htm.writetitle("Non-Inverting Amplifier");
            			
            				htm.write_expt_title("Non-Inverting Amplifier");
...
//            				htm.write_calc(filecalculation);
              			...
              			String []ss=new String[1];
            				...
            				//String []ss=new String[1];
            				Compress c =new Compress(ss, "/sdcard/newexpt3/inv/"+rno+"_expti3.zip"); 
            				c.zip();
            				//<<<<<<<<<<<<<UPLOADING>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>

            				AlertDialog.Builder builder = new AlertDialog.Builder(tabulation3.this);

...
import android.widget.TableLayout.LayoutParams;
        ...
        public class tabulation6 extends Activity {
        	...
        	public void onCreate(Bundle savedInstanceState) {
                ...
                setContentView(R.layout.tabulation6);
...
//        				tr1.setVisibility(View.INVISIBLE);
        		...
        		clear.setOnClickListener(new OnClickListener() {
        			...
        			public void onClick(View arg0) {
        				...
        				myintent.setClass(getApplicationContext(), tabulation6.class);
        		...
        		conclusion.setOnClickListener(new OnClickListener() {
        			...
        			public void onClick(View arg0) {
        				...
        				final Dialog dialog = new Dialog(tabulation6.this);
...
//            				String filecalculation[]=new String[1];
            				...
            				try
            				{
            					File folder=new File("/sdcard/newexpt4/");
            					...
            					File folder1 = new File("/sdcard/newexpt4/tab/");
            					if(!folder1.exists())
            						folder1.mkdir();
            					else
            					{
            				...
            				String file="/sdcard/newexpt4/tab/"+rno+"_expt4.html";
...
//            				htm.write_calc(filecalculation);
              			...
              			String []ss=new String[1];
            				...
            				//String []ss=new String[1];
            				Compress c =new Compress(ss, "/sdcard/newexpt4/tab/"+rno+"_expt4.zip"); 
            				c.zip();
            				//<<<<<<<<<<<<<UPLOADING>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>

            				AlertDialog.Builder builder = new AlertDialog.Builder(tabulation6.this);

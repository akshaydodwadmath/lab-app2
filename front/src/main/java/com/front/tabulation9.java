...
public class tabulation9 extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tabulation9);
...
b1.setEnabled(false);
		...
		b1.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				TableRow tr[]=new TableRow[row];
				
				b1.setEnabled(false);
				//rows.setEnabled(false);
				
				for(int i=rowp;i<row;i++)
				{
...
//		cvalues[0][0].setOnCheckedChangeListener(new OnCheckedChangeListener() {
//			
//			@Override
...
//					for(int j=0;j<1;j++)
//					{
//						cvalues[i][j]=new CheckBox(getApplicationContext());
////						cvalues[i][j].setWidth(100);
////						cvalues[i][j].setText("---");
//						cvalues[i][j].setGravity(1);
//						tr[i].addView(cvalues[i][j], new TableRow.LayoutParams(android.view.ViewGroup.LayoutParams.WRAP_CONTENT, android.view.ViewGroup.LayoutParams.WRAP_CONTENT));
...
//		try
//		{
//		cvalues[0][0].setOnClickListener(new OnClickListener() {
//			
//			@Override
//			public void onClick(View arg0) {
//				// TODO Auto-generated method stub
//				Toast.makeText(getApplicationContext(), "HI", 500).show();
//			}
//		});
//		}
//		catch (Exception e) {
...
//		}
		...
		clear.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				myintent.setClass(getApplicationContext(), tabulaton8.class);
			...
			public void onClick(View arg0) {
				...
				try
				{
					for(int i=0;i<row;i++)
					{
						...
						vi[i]=Double.parseDouble(evalues[i][1].getText().toString());
						
						
						
						vo[i]=Double.parseDouble(evalues[i][2].getText().toString());
		...
		conclusion.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				final Dialog dialog = new Dialog(tabulation9.this);
    			...
    			try{
    				...
    				//tabulations
    				  ...
    				  SharedPreferences set=getSharedPreferences("exp5", 0);
    					...
    					subheads[0]="";
    					HeaderHTM heads[]=new HeaderHTM[6];
    					heads[0]=new HeaderHTM("Obs.<br/>No", subheads, 0, 0);
    					heads[1]=new HeaderHTM("f<br/>V(Hz)", subheads, 0, 0);
    					heads[2]=new HeaderHTM("V<sub>i</sub>", subheads, 0, 0);
    					heads[3]=new HeaderHTM("V<sub>o</sub>", subheads, 0, 0);
    					heads[4]=new HeaderHTM("Gain(A)", subheads, 0, 0);
    					heads[5]=new HeaderHTM("Gain(db)", subheads, 0, 0);
    					

    				String filetable[][]=new String[row][6];
    	            ...
    	            filetable[i][4]=edi.getString("col4"+(i+1), "");
...
//    				String filecalculation[]=new String[1];
    				...
    				try
    				{
    					File folder=new File("/sdcard/newexpt5");
    					...
    					File folder1 = new File("/sdcard/newexpt5/HPF/");
    					if(!folder1.exists())
    						folder1.mkdir();
    					else
    					{
    				...
    				String file="/sdcard/newexpt5/HPF/"+rno+"_expt5h.html";
    				
    				Filehtml htm=new Filehtml(file);
    			
    				htm.writetitle("Mosfet as an Amplifier");
    			
    				htm.write_expt_title("Mosfet as an Amplifier");
...
//    				htm.write_calc(filecalculation);
      			...
      			String []ss=new String[1];
    				...
    				//String []ss=new String[1];
    				Compress c =new Compress(ss, "/sdcard/newexpt5/HPF/"+rno+"_expt5h.zip"); 
    				c.zip();
    				//<<<<<<<<<<<<<UPLOADING>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>

    				AlertDialog.Builder builder = new AlertDialog.Builder(tabulation9.this);
...
//				// TODO Auto-generated method stub
//				
//				float freq1[]=new float[row];
//				float gdb1[]=new float[row];
//				for(int i=0;i<row;i++)
//				{
//					freq1[i]=Float.parseFloat(evalues[i][0].getText().toString());
//					
//					
//					
//					
...
//					
//					
//				gdb1[i]=Float.parseFloat(tvalues[i][2].getText().toString());
//											
//				}
//				
//				bundle1.putFloatArray("freq", freq1);
//				bundle1.putFloatArray("gdb", gdb1);
//
//        		Intent myintent = new Intent();
//	            myintent.setClass(getApplicationContext(), Graph_exp5_caller.class);

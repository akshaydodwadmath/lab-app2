...
public class design4 extends Activity {
    public void onCreate(Bundle savedInstanceState) {
        ...
        b2.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				Intent i=new Intent(getApplicationContext(), tabulation3.class);
				startActivity(i);
...
//    				htm.write_calc(filecalculation);
    		...
    		//		htm.write_concl(conclus);
      			...
      			String []ss=new String[1];
    				...
    				AlertDialog.Builder builder = new AlertDialog.Builder(design4.this);

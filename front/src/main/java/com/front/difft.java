...
public class difft extends Activity {
...
//				tr1.setVisibility(View.INVISIBLE);
		...
		clear.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				myintent.setClass(getApplicationContext(), intgt.class);
		...
		conclusion.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				final Dialog dialog = new Dialog(difft.this);
...
//    				String filecalculation[]=new String[1];
    				...
    				try
    				{
    					...
    					File folder1 = new File("/sdcard/expt1/diff/");
    					if(!folder1.exists())
    						folder1.mkdir();
    					else
    					{
    				...
    				String file="/sdcard/expt1/diff/"+rno+"_expt1.html";
...
//    				htm.write_calc(filecalculation);
      			...
      			String []ss=new String[1];
    				...
    				//String []ss=new String[1];
    				Compress c =new Compress(ss, "/sdcard/expt1/diff/"+rno+"_expt1.zip"); 
    				c.zip();
    				//<<<<<<<<<<<<<UPLOADING>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>

    				AlertDialog.Builder builder = new AlertDialog.Builder(difft.this);

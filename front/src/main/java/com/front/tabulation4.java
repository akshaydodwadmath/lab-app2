...
import android.widget.TableLayout.LayoutParams;
        ...
        public class tabulation4 extends Activity {
        	...
        	public void onCreate(Bundle savedInstanceState) {
                ...
                setContentView(R.layout.tabulation3);
...
//        				tr1.setVisibility(View.INVISIBLE);
        		...
        		conclusion.setOnClickListener(new OnClickListener() {
        			...
        			public void onClick(View arg0) {
        				...
        				final Dialog dialog = new Dialog(tabulation4.this);
...
//            				String filecalculation[]=new String[1];
            				...
            				try
            				{
            					...
            					File folder1 = new File("/sdcard/newexpt3/nv/");
            					if(!folder1.exists())
            						folder1.mkdir();
            					else
            					{
            				...
            				String file="/sdcard/newexpt3/nv/"+rno+"_expt3.html";
...
//            				htm.write_calc(filecalculation);
              			...
              			String []ss=new String[1];
            				...
            				//String []ss=new String[1];
            				Compress c =new Compress(ss, "/sdcard/newexpt3/nv/"+rno+"_expt3.zip"); 
            				c.zip();
            				//<<<<<<<<<<<<<UPLOADING>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>

            				AlertDialog.Builder builder = new AlertDialog.Builder(tabulation4.this);

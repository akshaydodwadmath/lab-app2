...
//import com.expt1.Compress;
//import com.expt1.Filehtml;
//import com.expt1.HeaderHTM;
//import com.expt1.Upload;
import com.front.tabulaton11;
import com.front.R;
...
public class tabulaton11 extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.expt11);
...
//				tr1.setVisibility(View.INVISIBLE);
		...
		clear.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				myintent.setClass(getApplicationContext(), tabulaton11.class);
...
//		
		...
		conclusion.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				final Dialog dialog = new Dialog(tabulaton11.this);
...
//    				String filecalculation[]=new String[1];
    				...
    				try
    				{
    					...
    					File folder1 = new File("/sdcard/expt1/new3/");
    					if(!folder1.exists())
    						folder1.mkdir();
    					else
    					{
    				...
    				String file="/sdcard/expt1/new3/"+rno+"_expt1.html";
...
//    				htm.write_calc(filecalculation);
      			...
      			String []ss=new String[1];
    				...
    				//String []ss=new String[1];
    				Compress c =new Compress(ss, "/sdcard/expt1/new3/"+rno+"_expt1.zip"); 
    				c.zip();
    				//<<<<<<<<<<<<<UPLOADING>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>

    				AlertDialog.Builder builder = new AlertDialog.Builder(tabulaton11.this);

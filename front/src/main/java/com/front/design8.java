...
public class design8 extends Activity {
    /** Called when the activity is first created. */
    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.design8);
...
//	Button b2 =(Button)findViewById(R.id.button3);
	...
	final EditText t6=(EditText)findViewById(R.id.EditText01);
	final EditText t7=(EditText)findViewById(R.id.EditText02);
	final EditText t8=(EditText)findViewById(R.id.EditText03);
	final EditText t9=(EditText)findViewById(R.id.EditText04);
	final EditText t10=(EditText)findViewById(R.id.EditText05);
...
//				String filecalculation[]=new String[1];
				...
				try
				{
					...
					File folder1 = new File("/sdcard/newexpt5/design/");
					if(!folder1.exists())
						folder1.mkdir();
					else
					{
				...
				String file="/sdcard/newexpt5/design/"+rno+"_exptd5.html";
...
//				htm.write_calc(filecalculation);
				...
				htm.write_ex("1.Assumed Fh :");
				htm.write_ex2(t1.getText().toString());
				htm.write_ex("2.Assumed C :");
				htm.write_ex2(t2.getText().toString());
				htm.write_ex("3.Assumed R1 :");
		...
		//		htm.write_concl(conclus);
  			...
  			String []ss=new String[1];
				...
				//String []ss=new String[1];
				Compress c =new Compress(ss, "/sdcard/newexpt5/design/"+rno+"_exptd5.zip"); 
				c.zip();
				//<<<<<<<<<<<<<UPLOADING>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>

				AlertDialog.Builder builder = new AlertDialog.Builder(design8.this);
